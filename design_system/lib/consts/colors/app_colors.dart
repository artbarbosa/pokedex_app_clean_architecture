...
class AppColors {
  static const Color primary = Color(0xFF0804B4);
  ...
  static const Color red = Color(0xFFF10A34);
  ...
  static const Color fakeBlack = Color(0xFF555252);

  static const Color grass = Color(0xFF70D090);
  static const Color fire = Color(0xFFEC8C4C);
  static const Color water = Color(0xFF20C5F5);
  static const Color normal = Color(0xFFFFE0CA);
  static const Color poison = Color(0xFFDDA1E7);
  static const Color eletric = Color(0xFFFCF47C);
  static const Color ground = Color(0xFF9E6E53);
  static const Color fairy = Color(0xFFFDB7DA);
  static const Color bug = Color(0xFFD0EC94);
  static const Color fighting = Color(0xFFB8B8B8);
  static const Color psychic = Color(0xFFA98DF8);
  static const Color rock = Color(0xFF9A8371);
  static const Color steel = Color(0xFF89A0B3);
  static const Color ghost = Color(0xFFCDCDCD);
  static const Color dragon = Color(0xFFB7DBFF);
  static const Color dark = Color(0xFF8D8ECB);
}
